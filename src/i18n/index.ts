...
const resources = {
  en: {
    translation: {
      ...
      notifToday: "Today",
      notifNow: "Now",
      notifQuoteSentTitle: "Quote sent",
      notifQuoteSentBody: "AED {{amount}} is now with the customer.",
      notifNewOppTitle: "New opportunity near you",
      notifNewOppBody: "{{title}} in {{area}} needs a provider.",
      notifCustomerMsgTitle: "Customer message",
    },
  },
  hi: {
    translation: {
      ...
      notifTitle: "सूचनाएं",
      notifMarkAllRead: "सभी पढ़ा हुआ करें",
      notifToday: "आज",
      notifNow: "अभी",
      notifQuoteSentTitle: "Quote भेजा गया",
      notifQuoteSentBody: "AED {{amount}} अब customer के पास है।",
      notifNewOppTitle: "आपके पास नया काम",
      notifNewOppBody: "{{area}} में {{title}} के लिए provider चाहिए।",
      notifCustomerMsgTitle: "Customer का संदेश",
    },
  },
  ur: {
    translation: {
      ...
      notifTitle: "اطلاعات",
      notifMarkAllRead: "سب پڑھا ہوا نشان زد کریں",
      notifToday: "آج",
      notifNow: "ابھی",
      notifQuoteSentTitle: "Quote بھیج دیا",
      notifQuoteSentBody: "AED {{amount}} اب customer کے پاس ہے۔",
      notifNewOppTitle: "آپ کے قریب نیا کام",
      notifNewOppBody: "{{area}} میں {{title}} کے لیے provider درکار ہے۔",
      notifCustomerMsgTitle: "Customer کا پیغام",
    },
  },
  bn: {
    translation: {
      ...
      notifToday: "আজ",
      notifNow: "এখন",
      notifQuoteSentTitle: "Quote পাঠানো হয়েছে",
      notifQuoteSentBody: "AED {{amount}} এখন customer-এর কাছে।",
      notifNewOppTitle: "আপনার কাছে নতুন কাজ",
      notifNewOppBody: "{{area}}-এ {{title}}-এর জন্য provider দরকার।",
      notifCustomerMsgTitle: "Customer-এর বার্তা",
    },
  },
  tl: {
    translation: {
      ...
      notifMarkAllRead: "Markahan lahat bilang nabasa",
      notifToday: "Ngayon",
      notifNow: "Ngayon lang",
      notifQuoteSentTitle: "Naipadala ang quote",
      notifQuoteSentBody: "AED {{amount}} ay nasa customer na.",
      notifNewOppTitle: "Bagong trabaho malapit sa iyo",
      notifNewOppBody: "Kailangan ng provider para sa {{title}} sa {{area}}.",
      notifCustomerMsgTitle: "Mensahe ng customer",
    },
  },
  ne: {
    translation: {
      ...
      notifTitle: "सूचनाहरू",
      notifMarkAllRead: "सबै पढिएको रूपमा चिन्ह लगाउनुहोस्",
      notifToday: "आज",
      notifNow: "अहिले",
      notifQuoteSentTitle: "Quote पठाइयो",
      notifQuoteSentBody: "AED {{amount}} अब customer सँग छ।",
      notifNewOppTitle: "तपाईं नजिक नयाँ काम",
      notifNewOppBody: "{{area}} मा {{title}} का लागि provider चाहिन्छ।",
      notifCustomerMsgTitle: "Customer को सन्देश",
    },
  },
} as const;
